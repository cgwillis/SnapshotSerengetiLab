...
spatialplotTab <- tabItem(
  ...
  fluidRow(
    box(width=4,
        ...
        'You can use the filters to narrow down what photos you are interested in. Click the advance option to select additional filters. You can also select two species to compare at one time. The data for each species will be represented by a different color.', br(),br(),
        'Use the menu icon in the upper left corner of the map to can change the underlying map or toggle variables on and off.', br(),br(),
        'There is no download feature for the map. To save a map you must take a screenshot.', br(),
        h2('Data Filters:'),
